...
- (void) viewDidLoad
{
    ...
    NSLog(@"%f",self.subscriptionLayoutIPhone.collectionViewContentSize.height);
    NSLog(@"%f",self.channelLayoutIPhone.collectionViewContentSize.height);
    
    NSLog(@"%@",[self getHeaderTitleForChannels]);
