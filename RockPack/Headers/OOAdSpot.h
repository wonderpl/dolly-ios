...
@property(readonly, nonatomic, strong) NSNumber *time; /**< The time at which the OOAdSpot should be played */
@property(readonly, nonatomic, strong) NSURL *clickURL; /**< The URL which should be opened when the OOAdSpot is clicked */
@property(readonly, nonatomic, strong) NSArray *trackingURLs; /**< The Array of URLs which should be pinged when the OOAdSpot plays */
@property(nonatomic, strong) OOPlayerAPIClient *api;   /**< @internal The API that was used to fetch the OOAdSpot */
 ...
 */
+ (OOAdSpot *)adSpotFromDictionary:(NSDictionary *)data api:(OOPlayerAPIClient *)api;
